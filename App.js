...
const INITIAL_GAME_SPEED = 4; // Reduced base speed by 20% (was 5)
const MAX_GAME_SPEED = 9.6; // Reduced max speed by 20% (was 12)
const SPEED_INCREASE_RATE = 0.08; // Reduced speed increase rate by 20% (was 0.1)
